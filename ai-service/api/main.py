...
_allowed_origins = os.getenv(
    ...
    "http://localhost:3000,http://localhost:3001,https://compila.dev"
).split(",")
...
app.include_router(code_evaluation.router, prefix="/api/v1/code-evaluation", tags=["code-evaluation"])
app.include_router(
    code_evaluation_ws.router,
    prefix="/api/v1/code-evaluation/ws",
    tags=["code-evaluation-ws"],
)
